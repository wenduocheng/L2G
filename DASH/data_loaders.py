...
# def load_deepsea_full(batch_size, one_hot = True, valid_split=-1):
#     path = "/home/wenduoc/ORCA/clean/gene-orca/datasets/deepsea_full/"
...
def load_deepsea_full(batch_size, one_hot = True, valid_split=-1,quantize=False,rc_aug=False, shift_aug=False):
    # import mat73
...
def load_nucleotide_transformer(batch_size, one_hot = True, valid_split=-1, dataset_name = 'enhancers', quantize=False, rc_aug = False, shift_aug=False):
    ...
    ds_train = NucleotideTransformerDataset(
            max_length = max_length,
            dest_path = '/home/wenduoc/ORCA/clean/gene-orca/datasets' + '/nucleotide_transformer_downstream_tasks',
            use_padding = use_padding,
            split = 'train',
    ...
    if rc_aug:
        ds_train2 = NucleotideTransformerDataset(
            max_length = max_length,
            dest_path = '/home/wenduoc/ORCA/clean/gene-orca/datasets',
            use_padding = use_padding,
            split = 'train',
            # dest_path="/home/wenduoc/DASH/src_ablations/data",
            tokenizer=tokenizer,
            dataset_name=dataset_name,
            rc_aug=True,
            add_eos=add_eos,
